      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-lg p-8">
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/auth/signup" className={`bg-gradient-to-r ${theme.colors.textGradient} bg-clip-text text-transparent hover:underline font-medium`}>
              Sign up
            </Link>
          </p>
        </div>
