      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <h1 className={`text-3xl font-bold bg-gradient-to-r ${theme.colors.textGradient} bg-clip-text text-transparent`}>
              Morph AI
            </h1>
          </Link>
          <h2 className="text-2xl font-bold mb-2 text-white">Create Account</h2>
          <p className="text-gray-400">Start creating magic today</p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className={`w-full bg-gradient-to-r ${theme.colors.buttonGradient} hover:opacity-90 text-white`}
            >
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/auth/signin" className={`bg-gradient-to-r ${theme.colors.textGradient} bg-clip-text text-transparent hover:underline font-medium`}>
              Sign in
            </Link>
          </p>
        </div>
